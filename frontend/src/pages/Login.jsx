      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8">
            ...
            <a href="/resume-public" className="block text-center mt-2 text-sm font-medium text-blue-700 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 border border-blue-100 rounded-xl py-2.5 transition-colors">
              📊 Consulter le résumé (visiteur, sans compte)
            </a>
          </div>
