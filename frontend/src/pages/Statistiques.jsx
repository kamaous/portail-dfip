  ...
  return (
    <div className="card space-y-4">
      ...
      <p className="text-[11px] text-slate-400">
        Les plages du Planning annuel s'appliquent selon l'option définie par le Directeur DES (Référentiel). Pour organiser plusieurs formations, promotions ou niveaux
